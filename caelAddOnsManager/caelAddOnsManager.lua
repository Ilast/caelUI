...
local addons = {
	...
	["raid"]	= {"BigWigs", "BigWigs_Citadel", "BigWigs_Coliseum", "BigWigs_Core", "BigWigs_Foreign", "BigWigs_Naxxramas", "BigWigs_Northrend", "BigWigs_OnyxiasLair", "BigWigs_Options", "BigWigs_Plugins", "BigWigs_Ulduar", "caelBossWhisperer", "caelDefile", "recDamageMeter", "recThreatMeter"},
