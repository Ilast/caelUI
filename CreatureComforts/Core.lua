...
local function Print(str, ...)
	...
	DEFAULT_CHAT_FRAME:AddMessage("|cFFABD473Creature Comforts:|r "..str)
end
...
function CreatureComforts:ADDON_LOADED(addon)
	...
	if CreatureComfortsStrings then CreatureComfortsStrings = nil end
...
CreatureComforts.PLAYER_TALENT_UPDATE = CreatureComforts.CHARACTER_POINTS_CHANGED
